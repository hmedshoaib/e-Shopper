...
export default function Home() {
    ...
    return (
        <>
            <section id="home-section" className="hero bg1">
                <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img src="assets/images/bg_1.png" height="650px" className="d-block w-100" alt="..." />
                        </div>
                        <div className="carousel-item">
                            <img src="assets/images/bg_2.png" height="650px" className="d-block w-100" alt="..." />
                        </div>
                        {/* <div className="carousel-item">
                            ...
                            product.map((item, index) => {
                                return <div key={index} className="col-sm-12 col-md-6 col-lg-3  d-flex">
                                    <div className="product d-flex flex-column">
                                        <a target='_blank' href={`/assets/images/${item.pic1}`} className="img-prod"><img className="img-fluid" src={`/assets/images/${item.pic1}`} alt="" style={{ height: "220px", width: "100%" }} />
                                        ...
                                        <div className="text py-3 pb-4 px-3">
                                            ...
                                            <div className="pricing">
                                                <p className="price"><span className="mr-2 price-dc">&#8377;{item.baseprice}</span><sub><span className="price-sale">&#8377;{item.finalprice}</span></sub></p>
                                            </div>
                            ...
                            <div className="row no-gutters choose-wrap divider-two align-items-stretch">
                                ...
                                <div className="col-md-12">
                                    <div className="row no-gutters">
                                        ...
                                        <div className="col-md-6">
                                            <div className="choose-wrap wrap img align-self-stretch d-flex align-items-center" style={{ backgroundImage: "url('assets/images/kid (3).jpg')" }}>
                                                <div className="text text-center text-white px-5 mt-5">
                                                    <h2>Kid'd Collection</h2>
                                                    <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
            ...
            <section className="ftco-section testimony-section p-5">
                <div className="container">
                    <div className="services-flow row p-1">
            ...
            <section className="ftco-gallery mb-0">
                <Newslatter/>
